...
public class custom_order {
    ...
    // STEP 2 CREATE A SCANNER OBEJCT, DECLARE VARAIBLES, & PRINT STATEMENTS
	  ...
	  String itemOrder; // Articulo ordenado
	  String frostingType;// Glaseado ordenado
	  String fillingType;// Llenado ordenado
	  String toppings; // Ingredientes ordenados
	  String input; // Entrada del usuario

	  double cost=15.00; // Costo de pastel y pastelitos
	  final double TAX_RATE=.08; // Tasa de impuesto a las ventas
	  double tax; // Cantidad de impuestos


    // Introduce shop and prompt user to input first name
    // Introduzca la tienda y solicite al usuario que ingrese el nombre
